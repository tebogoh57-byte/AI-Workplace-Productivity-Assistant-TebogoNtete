...
## 📋 Project Overview
A modern, responsive web application that helps professionals automate daily workplace tasks using Artificial Intelligence.
...
> You are a professional email assistant. Generate a [TONE] email to [RECIPIENT] about [TOPIC]. Context: [CONTEXT]. Keep it concise, professional and actionable.

**Meeting Summarizer Prompt:**
> You are an executive assistant. Summarize these meeting notes into: 1. Summary (3 bullets) 2. Action Items (with owner) 3. Decisions Made 4. Deadlines. Notes: [PASTE]
...
- Complies with workplace AI ethics and
